...
?>
    ...
    <div class="login-area">
        ...
        <div class="form-group col-md-12 <?php echo (!empty($rollno_err)) ? 'has-error' : ''; ?>">
            <input type="text" class="form-control" name="rollno" placeholder="Student Number">
        ...
        <div class="form-group col-md-12 <?php echo (!empty($branch_err)) ? 'has-error' : ''; ?>">
            <input type="text" class="form-control" name="branch" placeholder="Departement">
        ...
        <div class="form-group col-md-12 <?php echo (!empty($bg_err)) ? 'has-error' : ''; ?>">
            <input type="text" class="form-control" name="bg" placeholder="Group Name">
